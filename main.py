...
def his_model():
    ...
    X_train, y_train = load_mnist('/Users/saakethkoka/Documents/MachineLearning/MachineLearningNotebooks/data/', kind='fashion_train')
    print('Rows: %d, columns: %d' % (X_train.shape[0], X_train.shape[1]))

    X_test, y_test = load_mnist('/Users/saakethkoka/Documents/MachineLearning/MachineLearningNotebooks/data/', kind='fashion_t10k')
    ...
    model = TLPMiniBatchCrossEntropy(**vals)
    model.fit(X_train, y_train)
